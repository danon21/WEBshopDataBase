...
public class WorkData {
    ...
    public static final ArrayList<CUser> users = new ArrayList<>();
    public static final ArrayList<CGood> goods = new ArrayList<>();
    public static final ArrayList<COrder> orders = new ArrayList<>();

    @Autowired
    public IRepositoryUsers repositoryUsers;
    @Autowired
    public IRepositoryGoods repositoryGoods;
    @Autowired
    public IRepositoryOrders repositoryOrders;

    //Метод загрузки товаров из файла
    public static void LoadGoods(XSSFWorkbook wb) {
    ...
    public static void LoadOrder(XSSFWorkbook wb) {
    ...
    public static void LoadUsers(XSSFWorkbook wb) {
    ...
    public void load(XSSFWorkbook wb) {
        //File file = new File("D:\\study\\java\\WEBShopDataBaseData", "Magazin.xlsx");
    ...
    public static XWPFDocument CreateWordReport(Map<String, Integer> dict) {
    ...
    public XWPFDocument report() {
        ...
        XWPFDocument doc = CreateWordReport(dict);
        return doc;
    }
}